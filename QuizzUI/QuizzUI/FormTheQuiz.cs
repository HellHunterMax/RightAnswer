...
namespace QuizzUI
{
    public partial class FormTheQuiz : Form
    {
        ...
        /// <summary>
        /// Creates a panel for the question with all the possible answers for the asked question.
        /// </summary>
        ...
        private void CreatePanelForQuestion(QuestionModel theQuestion)
        {
            ...
            //Creating a panel for the question with answers for easy dispose.
            Panel Panel1 = new Panel
            {
                Size = new Size(1000, (numberOfAnswers * 75) + 200),
                Location = new Point(12, 12)
            };
            AddQuestionLabelsAndAnswerButtons();
            ...
            void AddQuestionLabelsAndAnswerButtons()
            {
        ...
        /// <summary>
        /// Gets a list of possible Questions from the SQL server.
        /// </summary>
